...
# Set sharpness manually (adjust value according to your camera range)
camera.Sharpness.Value = 800
...
while camera.IsGrabbing():
    ...
    if grab_result.GrabSucceeded():
        ...
        # SCALE DOWN the image to simulate zooming out (e.g., to 50% size)
        scaled_img = cv2.resize(img_bgr, (0, 0), fx=0.2, fy=0.2)

        # Run YOLO inference on the scaled image
        ...
        # Display the scaled, annotated frame
